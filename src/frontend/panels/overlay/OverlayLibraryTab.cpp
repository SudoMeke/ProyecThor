...
// ─────────────────────────────────────────────────────────────────────────────
bool OverlayLibraryTab::SaveOverlayRecipe(const std::string& name, const OverlayDoc& doc) {
...
bool OverlayLibraryTab::LoadOverlayRecipe(const std::string& name, OverlayDoc& out) {
