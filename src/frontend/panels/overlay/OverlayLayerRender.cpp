...
void DrawOverlayLayerStyledText(ImDrawList* dl, ImFont* font, float displaySize,
    ...
    ImU32 col = colorOverrideRGBA
        ? ImGui::ColorConvertFloat4ToU32(ImVec4(colorOverrideRGBA[0], colorOverrideRGBA[1], colorOverrideRGBA[2], colorOverrideRGBA[3]))
        : ImGui::ColorConvertFloat4ToU32(ImVec4(layer.color[0], layer.color[1], layer.color[2], layer.color[3]));
