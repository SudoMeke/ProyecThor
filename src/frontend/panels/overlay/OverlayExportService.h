...
//  child window (el canvas del editor de Overlays) a un PNG, reutilizando el
//  ImDrawList que ImGui ya construyo este mismo frame (no se dibuja nada a
//  mano: se re-renderiza ese mismo draw list contra un FBO propio, escalado
//  a la resolucion de exportacion via ImDrawData::FramebufferScale — el mismo
//  mecanismo que usa ImGui para pantallas HiDPI/Retina).
//
